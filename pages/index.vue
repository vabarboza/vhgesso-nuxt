      ...
      <div class="columns is-desktop">
        <div class="column">
          ...
          <div class="card">
            <div class="card-image">
              <figure class="image">
                <img src="~/assets/inicio/01.jpg" alt="Forro Liso">
              </figure>
            </div>
            <div class="card-content">
              <h2 class="title is-4">Forro Liso</h2>
              <p class="is-size-7">É a tendência do momento usado para revestir paredes e teto pela sua versatilidade, plasticidade e
        ...
        <div class="column">
          ...
          <div class="card">
            <div class="card-image">
              <figure class="image">
                <img src="~/assets/inicio/02.jpg" alt="Forro Liso">
              </figure>
            </div>
            <div class="card-content">
              <h2 class="title is-4">Molduras</h2>
              <p class="is-size-7">Molduras de Gesso há tempos é o toque final de acabamento colocando requinte nos perímetros dos
        ...
        <div class="column">
          ...
          <div class="card">
            <div class="card-image">
              <figure class="image">
                <img src="~/assets/inicio/03.jpg" alt="Forro Liso">
              </figure>
            </div>
            <div class="card-content">
              <h2 class="title is-4">Gesso Acartonado</h2>
              <p class="is-size-7">Esse sistema é popularmente chamado de parede ou forro de drywall, por isso, muitas pessoas confundem
      ...
      <div class="columns is-desktop">
        <div class="column">
          ...
          <div class="card">
            <div class="card-image">
              <figure class="image">
                <img src="~/assets/inicio/04.jpg" alt="Forro Liso">
              </figure>
            </div>
            <div class="card-content">
        ...
        <div class="column">
          ...
          <div class="card">
            <div class="card-image">
              <figure class="image">
                <img src="~/assets/inicio/05.jpg" alt="Forro Liso">
              </figure>
            </div>
            <div class="card-content">
        ...
        <div class="column">
          ...
          <div class="card">
            <div class="card-image">
              <figure class="image">
                <img src="~/assets/inicio/06.jpg" alt="Forro Liso">
              </figure>
            </div>
            <div class="card-content">
